    ...
    public void informacion(ActionEvent event) throws IOException {
        ...
        switch (id){
            case "productosMediosI" ->{
                ...
                cargarInformacion(event, "Info.fxml", InfoMenu.class, "Productos Medios", informacion);
            }
            case "multiplicacionContanetI" ->{
                ...
                cargarInformacion(event, "Info.fxml", InfoMenu.class, "Multiplicación Constante", informacion);
            }
            case "KsI" ->{
                ...
                cargarInformacion(event, "Info.fxml", InfoMenu.class, "Kolmogórov\nSmirnov (K-S)", informacion);
            }
            case "chiCuadradaI" ->{
                String informacion ="La prueba chiCuadrada consta de los siguientes pasos\n" +
                        ...
                        "hipótesis nula Ho.";
                cargarInformacion(event, "Info.fxml", InfoMenu.class, "Chi Cuadrada", informacion);
            }
            case "corridasI" ->{
                ...
                cargarInformacion(event, "Info.fxml", InfoMenu.class, "Corridas", informacion);
            }
            case "lehmerI" ->{
                ...
                cargarInformacion(event, "Info.fxml", InfoMenu.class, "Lehmer", informacion);
            }
            case "cuadradosMediosI" ->{
                ...
                cargarInformacion(event, "Info.fxml", InfoMenu.class, "Cuadrados Medios", informacion);
            }
            case "pruebaMediaI" ->{
                ...
                cargarInformacion(event, "Info.fxml", InfoMenu.class, "Prueba Media", informacion);
            }
            case "pruebaVarianzaI" ->{
                ...
                cargarInformacion(event, "Info.fxml", InfoMenu.class, "Prueba Varianza", informacion);
            }
